<x-filament-panels::page>
    ...
    <div class="space-y-4">
        <x-filament::tabs>
            ...
            <x-filament::tabs.item :active="$this->period === 'custom'" wire:click="$set('period', 'custom')"
        ...
        @if($this->period === 'daily')
            <x-filament::section compact>
                <div class="flex items-center gap-3">
                    ...
                    <input type="date" wire:model.live="dailyDate" max="{{ now()->toDateString() }}" class="rounded-lg border border-gray-300 dark:border-gray-600
        ...
        @if($this->period === 'monthly')
            <x-filament::section compact>
                <div class="flex items-center gap-3">
                    ...
                    <input type="month" wire:model.live="month" max="{{ now()->format('Y-m') }}" class="rounded-lg border border-gray-300 dark:border-gray-600
                                   bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100
                                   px-3 py-1.5 shadow-sm focus:border-primary-500 focus:ring-primary-500" />
                </div>
            </x-filament::section>
        ...
        @if($this->period === 'yearly')
            <x-filament::section compact>
                <div class="flex items-center gap-3">
                    ...
                    <select wire:model.live="year" class="rounded-lg border border-gray-300 dark:border-gray-600
                                   bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100
                                   px-3 py-1.5 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                ...
                <div class="flex flex-wrap items-center gap-6">
                    <div class="flex items-center gap-3">
                        ...
                        <input type="date" wire:model.live="customStart"
                            max="{{ $this->customEnd ?: now()->toDateString() }}" class="rounded-lg border border-gray-300 dark:border-gray-600
                                       bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100
                                       px-3 py-1.5 shadow-sm focus:border-primary-500 focus:ring-primary-500" />
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <input type="date" wire:model.live="customEnd" min="{{ $this->customStart ?: '' }}"
                            max="{{ now()->toDateString() }}" class="rounded-lg border border-gray-300 dark:border-gray-600
                                       bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100
                                       px-3 py-1.5 shadow-sm focus:border-primary-500 focus:ring-primary-500" />
                    </div>
                </div>
