...
<div id="tab-walkin" class="hidden space-y-6">
    <div id="walkin-full-alert"
        class="hidden flex items-center gap-4 p-5 rounded-3xl bg-danger-50 dark:bg-danger-900/20 border border-danger-100 dark:border-danger-800 text-danger-700 dark:text-danger-400 shadow-sm">
    ...
    <div id="walkin-form" class="hidden space-y-6 transition-all duration-500">
