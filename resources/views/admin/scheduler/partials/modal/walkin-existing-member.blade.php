...
<div id="walkin-existing-section" class="hidden space-y-4">
    <div class="relative">
        <label class="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1 mb-2 block">{{ __('dashboard.scheduler_ui.modal.quick_search_label') }}</label>
        <div
            ...
            <input type="text" id="walkin-search" placeholder="{{ __('dashboard.scheduler_ui.modal.quick_search_placeholder') }}"
    ...
    <button id="btn-submit-existing" type="button" disabled
        ...
        <div class="flex items-center justify-center gap-3">
            <span id="btn-submit-existing-text">{{ __('dashboard.scheduler_ui.modal.select_members_button') }}</span>
        </div>
    </button>
</div>