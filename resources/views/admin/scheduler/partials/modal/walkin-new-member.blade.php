...
<div id="walkin-new-section" class="hidden space-y-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="space-y-2">
            <label class="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">{{ __('dashboard::dashboard.scheduler_ui.modal.full_identity_label') }} <span
                    class="text-danger-500">*</span></label>
            <input type="text" id="input-fullname" placeholder="{{ __('dashboard::dashboard.scheduler_ui.modal.name_placeholder') }}"
        ...
        <div class="space-y-2">
            <label class="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">{{ __('dashboard::dashboard.scheduler_ui.modal.mobile_label') }} <span
                    class="text-danger-500">*</span></label>
            <input type="text" id="input-phone" placeholder="{{ __('dashboard::dashboard.scheduler_ui.modal.phone_placeholder') }}"
                class="w-full bg-gray-50 dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-700 rounded-2xl px-5 py-3.5 text-sm font-bold text-gray-900 dark:text-white placeholder-gray-400 focus:border-primary-500 outline-none transition-all" />
            <p id="err-phone" class="hidden text-[10px] font-bold text-danger-500 ml-1"></p>
        </div>
        <div class="space-y-2 sm:col-span-2">
            <label class="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">{{ __('dashboard::dashboard.scheduler_ui.modal.email_label') }}</label>
            <input type="email" id="input-email" placeholder="{{ __('dashboard::dashboard.scheduler_ui.modal.email_placeholder') }}"
                class="w-full bg-gray-50 dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-700 rounded-2xl px-5 py-3.5 text-sm font-bold text-gray-900 dark:text-white placeholder-gray-400 focus:border-primary-500 outline-none transition-all" />
    ...
    <button id="btn-submit-new" type="button"
        ...
        <div class="flex items-center justify-center gap-3">
            <span id="btn-submit-new-text">{{ __('dashboard::dashboard.scheduler_ui.modal.register_walkin_button') }}</span>
        </div>
    </button>
</div>