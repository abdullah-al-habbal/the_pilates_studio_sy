...
<div
    ...
    <div id="modal-header-content" class="transition-all duration-300">
        <h2 id="modal-title" class="text-xl font-black text-gray-900 dark:text-white tracking-tight">{{ __('dashboard.scheduler_ui.modal.title') }}
        </h2>
    ...
    <div class="flex items-center gap-2 shrink-0">
        <button id="btn-adjust-capacity" type="button"
            ...
            title="{{ __('dashboard.scheduler_ui.capacity_modal.title') }}">
