...
<div id="modal-container">
    <div id="modal-backdrop" class="hidden fixed inset-0 z-40 bg-gray-900/60 backdrop-blur-sm"></div>
    <div id="modal-panel"
        class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 pointer-events-none">
