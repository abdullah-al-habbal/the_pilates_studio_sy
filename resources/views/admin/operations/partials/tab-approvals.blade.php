...
<div class="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
    <div class="space-y-2">
        <h2 class="text-2xl font-bold tracking-tight">{{ __('dashboard.operations_ui.approvals.title') }}</h2>
        <p class="text-slate-500">{{ __('dashboard.operations_ui.approvals.description') }}</p>
    </div>
    ...
    <div id="approvals-container">
        <div class="glass-card rounded-2xl p-8 text-center text-slate-400">
            <div class="flex flex-col items-center gap-3">
                ...
                <span>{{ __('dashboard.operations_ui.approvals.loading') }}</span>
            </div>
        </div>
    </div>
</div>
