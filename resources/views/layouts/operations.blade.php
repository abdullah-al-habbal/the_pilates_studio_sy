...
<head>
    ...
    <title>{{ __('dashboard.navigation.groups.operations') }} – {{ config('app.name') }}</title>
    ...
    <nav class="sticky top-0 z-50 glass-card border-b px-6 py-3 flex justify-between items-center">
        <div class="flex items-center gap-3 flex-wrap">
            <div
                ...
                P</div>
            <h1 class="text-xl font-bold tracking-tight">{{ __('dashboard.navigation.groups.operations') }} <span class="text-primary-500">Hub</span></h1>
            <a href="{{ url('/admin') }}"
