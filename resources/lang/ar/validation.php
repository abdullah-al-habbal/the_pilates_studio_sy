...
return [
    ...
    'doesnt_end_with' => 'حقل :attribute يجب ألا ينتهي بأحد مما يلي: :values.',
    'doesnt_start_with' => 'حقل :attribute يجب ألا يبدأ بأحد مما يلي: :values.',
    'email' => 'حقل :attribute يجب أن يكون بريداً إلكترونياً صالحاً.',
    'encoding' => 'حقل :attribute يجب أن يكون مشفراً بـ :encoding.',
    'ends_with' => 'حقل :attribute يجب أن ينتهي بأحد مما يلي: :values.',
    ...
    'in_array_keys' => 'حقل :attribute يجب أن يحتوي على مفتاح واحد على الأقل مما يلي: :values.',
    ...
    'numeric' => 'حقل :attribute يجب أن يكون عدداً.',
    'password' => [
    ...
    'starts_with' => 'حقل :attribute يجب أن يبدأ بأحد مما يلي: :values.',
