...
- Pulumi: `npx vitest` or `npx jest` per `pulumi/AGENTS.md`
- AI engine: bun-based runner per `ai/engine/AGENTS.md`
- Frontends: pnpm per `frontends/nextjs/AGENTS.md`
...
- **Do not** skip `phpcs` because "it's a tiny change." Project rules in `wp-cms/AGENTS.md` forbid suppression.
